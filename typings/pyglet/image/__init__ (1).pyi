...
class Texture(AbstractImage):
    ...
    @classmethod
    def create(cls, width, height, target=..., internalformat=..., min_filter=..., mag_filter=..., fmt=...): # -> Self@Texture:
        """Create a Texture
...
class Texture3D(Texture, UniformTextureSequence):
    ...
    items = ...
    @classmethod
    def create_for_images(cls, images, internalformat=...): # -> Self@Texture3D:
        ...
...
class BufferImage(AbstractImage):
    ...
    def get_region(self, x, y, width, height): # -> Self@BufferImage:
        ...
