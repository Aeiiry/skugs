...
class Glyph:
    ...
    def compile(self, glyfTable, recalcBBoxes=...): # -> bytes | bytearray:
        ...
    ...
    def decompileVarComponents(self, data, glyfTable): # -> None:
        ...
    ...
    def compileVarComponents(self, glyfTable): # -> bytes:
        ...
    ...
    def isVarComposite(self): # -> Any | bool:
        """Test whether a glyph has variable components"""
        ...
    
    def getCoordinates(self, glyfTable): # -> tuple[GlyphCoordinates, list[int], bytearray] | tuple[GlyphCoordinates, list[Unknown], bytearray]:
    ...
    def getComponentNames(self, glyfTable): # -> list[Unknown]:
...
class GlyphVarComponent:
    MIN_SIZE = ...
    def __init__(self) -> None:
        ...
    
    @staticmethod
    def getSize(data): # -> int:
        ...
    
    def decompile(self, data, glyfTable):
        ...
    
    def compile(self, glyfTable): # -> bytes:
        ...
    ...
    def getCoordinatesAndControls(self): # -> tuple[list[Unknown], list[Unknown]]:
        ...
...
class GlyphCoordinates:
    ...
    def __getitem__(self, k): # -> list[Unknown] | tuple[int | Unknown, int | Unknown]:
