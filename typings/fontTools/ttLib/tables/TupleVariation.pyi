...
class TupleVariation:
    ...
    @staticmethod
    def decompilePoints_(numPoints, data, offset, tableTag): # -> tuple[range, Unknown] | tuple[list[Unknown], Unknown]:
    ...
    def __imul__(self, scalar): # -> Self@TupleVariation:
        ...
    
    def __iadd__(self, other): # -> _NotImplementedType | Self@TupleVariation:
        ...
