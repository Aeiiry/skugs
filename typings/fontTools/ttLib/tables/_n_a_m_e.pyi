...
class table__n_a_m_e(DefaultTable.DefaultTable):
    ...
    def getDebugName(self, nameID): # -> None:
        ...
    
    def getFirstDebugName(self, nameIDs): # -> None:
        ...
    
    def getBestFamilyName(self): # -> None:
        ...
    
    def getBestSubFamilyName(self): # -> None:
        ...
    ...
    def findMultilingualName(self, names, windows=..., mac=..., minNameID=...): # -> None:
