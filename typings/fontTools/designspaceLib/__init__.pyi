...
__all__ = ["AxisDescriptor", "AxisLabelDescriptor", "BaseDocReader", "BaseDocWriter", "DesignSpaceDocument", "DesignSpaceDocumentError", "DiscreteAxisDescriptor", "InstanceDescriptor", "LocationLabelDescriptor", "RangeAxisSubsetDescriptor", "RuleDescriptor", "SourceDescriptor", "ValueAxisSubsetDescriptor", "VariableFontDescriptor"]
XML_NS = ...
XML_LANG = ...
def posix(path):
...
def tagForAxisName(name): # -> tuple[Literal['wght'], dict[str, str]] | tuple[Literal['wdth'], dict[str, str]] | tuple[Literal['opsz'], dict[str, str]] | tuple[Literal['slnt'], dict[str, str]] | tuple[Literal['ital'], dict[str, str]] | tuple[Unknown, dict[str, Unknown]]:
    ...
