...
def drop_implied_oncurves(glyph): # -> None:
    ...
...
class _TTGlyphBasePen:
    ...
    def glyph(self, componentFlags: int = ..., dropImpliedOnCurves=...) -> Glyph:
        """
...
class TTGlyphPen(_TTGlyphBasePen, LoggingPen):
    ...
    def __init__(self, glyphSet: Optional[Dict[str, Any]] = ..., handleOverflowingTransforms: bool = ..., outputImpliedClosingLine: bool = ...) -> None:
        ...
