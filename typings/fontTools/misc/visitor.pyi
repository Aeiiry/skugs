...
class Visitor:
    defaultStop = ...
    @classmethod
    def register(celf, clazzes): # -> (method: Unknown) -> None:
        ...
    
    @classmethod
    def register_attr(celf, clazzes, attrs): # -> (method: Unknown) -> None:
        ...
    
    @classmethod
    def register_attrs(celf, clazzes_attrs): # -> (method: Unknown) -> None:
        ...
