...
def splitQuadratic(pt1, pt2, pt3, where, isHorizontal): # -> list[tuple[Unknown, Unknown, Unknown]] | list[Unknown]:
...
def splitCubic(pt1, pt2, pt3, pt4, where, isHorizontal): # -> list[tuple[Unknown, Unknown, Unknown, Unknown]] | list[Unknown]:
...
def splitCubicAtTC(pt1, pt2, pt3, pt4, *ts): # -> Generator[tuple[Unknown, Unknown, Unknown, Unknown], None, None]:
    """Split a cubic Bezier curve at one or more values of t.
...
def splitCubicIntoTwoAtTC(pt1, pt2, pt3, pt4, t): # -> tuple[tuple[Unknown, Unknown, Unknown, Unknown], tuple[Unknown, Unknown, Unknown, Unknown]]:
...
def calcCubicParametersC(pt1, pt2, pt3, pt4): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
    ...
...
@cython.cfunc
@cython.locals(a=cython.complex, b=cython.complex, c=cython.complex, d=cython.complex, p2=cython.complex, p3=cython.complex, p4=cython.complex, _1_3=cython.double)
def calcCubicPointsC(a, b, c, d, _1_3=...): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
    ...
...
def lineLineIntersections(s1, e1, s2, e2): # -> list[Unknown] | list[Intersection]:
...
def segmentSegmentIntersections(seg1, seg2): # -> list[Intersection] | list[Unknown]:
