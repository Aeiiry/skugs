...
from typing import Any, Callable, ClassVar, Dict, Iterable, Mapping, MutableMapping, Optional, Union
...
class Options(Mapping):
    ...
    def register(self, name: str, help: str, default: Any, parse: Callable[[str], Any], validate: Optional[Callable[[Any], bool]] = ...) -> Option:
...
class AbstractConfig(MutableMapping):
    ...
    @classmethod
    def register_option(cls, name: str, help: str, default: Any, parse: Callable[[str], Any], validate: Optional[Callable[[Any], bool]] = ...) -> Option:
        """Register an available option in this config system."""
        ...
    
    _values: Dict[str, Any]
    def __init__(self, values: Union[AbstractConfig, Dict[Union[Option, str], Any]] = ..., parse_values: bool = ..., skip_unknown: bool = ...) -> None:
        ...
    
    def set(self, option_or_name: Union[Option, str], value: Any, parse_values: bool = ..., skip_unknown: bool = ...): # -> None:
