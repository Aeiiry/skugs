...
class Transform(NamedTuple):
    ...
    def translate(self, x=..., y=...): # -> Transform:
    ...
    def reverseTransform(self, other): # -> Transform:
    ...
    def inverse(self): # -> Self@Transform | Transform:
...
class DecomposedTransform:
    ...
    tCenterY: float = ...
    @classmethod
    def fromTransform(self, transform): # -> DecomposedTransform:
        ...
